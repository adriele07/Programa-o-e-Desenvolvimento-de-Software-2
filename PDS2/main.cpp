            ...
            if (isAlunoRegistrado(alunos, nomeDeUsuario)) {
                ...
                while (true) {
                    ...
                    case 2: {
                        ...
                        Aluno* aluno = nullptr;
                        for (auto& a : alunos) {
                            if (a.getNomeDeUsuario() == nomeDeUsuario) {
                                aluno = &a;
                                break;
                            }
                        }
                        ...
                        std::string dataDevolucao = getCurrentDate();
                        Emprestimo emprestimo(*livro, *aluno, dataDevolucao); // Use o aluno correto que está tentando devolver o livro
